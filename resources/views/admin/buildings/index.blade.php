...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="mt-4 ml-2" style="font-size: 25px">Building</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header bg-primary p-1">
                                <h3 class="card-title">
                                    <a href="{{ route('building.create') }}"class="btn btn-light shadow rounded m-0"><i
    ...
    <script>
        $('body').on('click', '.edit', function() {
            ...
            $.get("/admin/building/edit/" + building_id, function(data) {
