                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group text form">
                        ...
                        <select name="nationality" id="" class="form-control" required>
                            <option value="Bangladeshi" @if ( $data->nationality == 'Bangladeshi') selected @endif>Bangladeshi</option>
                            <option value="Indian" @if ( $data->nationality == 'Indian') selected @endif>Indian</option>
                            <option value="Pakistani" @if ( $data->nationality == 'Pakistani') selected @endif>Pakistani</option>
                        </select>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group text form">
                        ...
                        <input type="text" name="intercome_no"
                            value="{{ $data->intercome_no}}" class="form-control text"
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group text form">
                        ...
                        <input type="text" name="land_phone"
                            value="{{ $data->land_phone }}" class="form-control text"
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group text form">
                        ...
                        <input type="text"name="mobile_phone"
                            value="{{ $data->mobile_phone }}" class="form-control text"
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group text form">
                        ...
                        <input type="text" name="nid_no" value="{{ $data->nid_no }}"
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group text form">
                        ...
                        <input type="text" name="car_no" value="{{ $data->car_no }}"
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group text form">
                        ...
                        <input type="text" name="garage_no"
                            value="{{ $data->garage_no }}" class="form-control text"
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group form">
                        ...
                        <input type="text" name="occupation"
                            value="{{ $data->occupation }}" class="form-control text"
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group text form">
                        ...
                        <input type="text" name="designation"
                            value="{{ $data->designation }}" class="form-control text"
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group text form">
                        ...
                        <input type="text" name="institute_name"
                            value="{{ $data->institute_name }}" class="form-control text"
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group text">
                        ...
                        <input type="file" name="flat_reg_document"
                            ...
                            <img src="{{ asset($data->flat_reg_document) }}" style="width: 50px" alt="flat_reg_document ">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group text">
                        ...
                        <input type="text" name="family_member_name"
                            value="{{ $data->family_member_name }}" class="form-control"
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group text">
                        <label for="family_member_occupation" class="text">Family Member
                            Occupation</label>
                        <input type="text"
                            value="{{ $data->family_member_occupation }}"
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group text">
                        ...
                        <input type="text" value="{{ $data->family_member_age }}"
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group text">
                        <label for="family_member_relation" class="text">Family Member
                            Relation</label>
                        <input type="text" value="{{ $data->family_member_relation }}"
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group text">
                        ...
                        <input type="file" name="family_member_image"
                            class="form-control dropify" data-height="100">
                            <img src="{{ asset($data->family_member_image) }}" style="width: 50px" alt="family_member_image ">
