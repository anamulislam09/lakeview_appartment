                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                                            <label class="mpbtn col-md-3" style="cursor:pointer">
                                                <img id="image_view" style="max-width:100%" class="img-thumbnail" src="{{ asset('uploads/admin/'. (Auth::guard('admin')->user()->image? Auth::guard('admin')->user()->image : 'placeholder.png')) }}">
