            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                        ...
                        <img class="img-profile rounded-circle" src="{{ Auth::guard('admin')->user()->image? asset('/uploads/admin/'. Auth::guard('admin')->user()->image): asset('admin-assets/img/user.png') }}" height="30" width="30">
                    </a>
...
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" id="logout-model" role="document">
